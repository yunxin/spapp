function $_global_spgantt() {
    ...
    ULSc2E:
        ...
        ULSc2E:
            ...
            ULSc2E:
                ;
                return value == null ? null : (STSHtmlEncode(value.replace(/<br>/g, '\n'))).replace(/\n/g, "<br>");
            };
        };
    ...
    ULSc2E:
        ...
        ULSc2E:
            ...
            ULSc2E:
                ...
                try {
                    response = Sys.Serialization.JavaScriptSerializer.deserialize(responseData);
                }
                catch (e) {
    ...
    ULSc2E:
                                    ...
                                    if (bUserChange) {
                                        ...
                                        if ((_gridFieldMap[fieldKey].GetPropType()).ID == "SPDateTime") {
                                            ...
                                            if (gridItem == null) {
                                                ...
                                                localizedVal = (item.get_item(fieldKey))._toFormattedString("s", Sys.CultureInfo.InvariantCulture);
                                            }
                                        }
                                        else {
                                            localizedVal = localizedFieldValues[fieldKey];
        ...
        ULSc2E:
            ...
            ULSc2E:
                ;
                var date = new Date(Date.UTC(dataFromServer.getFullYear(), dataFromServer.getMonth(), dataFromServer.getDate(), dataFromServer.getHours(), dataFromServer.getMinutes(), dataFromServer.getSeconds(), dataFromServer.getMilliseconds()));
        ...
        ULSc2E:
            ...
            window.location.href = SP.Utilities.UrlBuilder.urlCombine(SP.PageContextInfo.get_webServerRelativeUrl(), url + '?ID=' + record.GetDataValue('ID'));
        }
        ...
        ULSc2E:
            ...
            if (_jsGridControl.DeleteRecords(nonEntryRecordKeys) != null) {
                if (realRecordsKeys.length != 0) {
                    ...
                    var ctx = InitContext(GetOnSucceeded(), GetOnFailed(true));
                    ...
                    for (var i = 0; i < realRecordsKeys.length; i++) {
                        ...
                        if (record.GetDataValue('Edit') & SPG.Permissions.deleteListItems) {
                            (ctx.list.getItemById(realRecordsKeys[i])).deleteObject();
                        }
                    }
                    ctx.context.executeQueryAsync();
                }
