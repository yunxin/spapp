...
SP.UI.Discussions.AsyncRefreshRequest.createCurrentViewRefreshRequest = function SP_UI_Discussions_AsyncRefreshRequest$createCurrentViewRefreshRequest($p0, $p1) {
    return SP.UI.Discussions.AsyncRefreshRequest.$18($p0, false, 0, null, $p1);
};
SP.UI.Discussions.AsyncRefreshRequest.createNewViewRefreshRequest = function SP_UI_Discussions_AsyncRefreshRequest$createNewViewRefreshRequest($p0, $p1) {
    return SP.UI.Discussions.AsyncRefreshRequest.$18($p0, false, 0, $p1, 3);
};
SP.UI.Discussions.AsyncRefreshRequest.createSingleItemRefreshRequest = function SP_UI_Discussions_AsyncRefreshRequest$createSingleItemRefreshRequest($p0, $p1) {
    return SP.UI.Discussions.AsyncRefreshRequest.$18($p0, true, $p1, null, 3);
};
SP.UI.Discussions.AsyncRefreshRequest.$18 = function SP_UI_Discussions_AsyncRefreshRequest$$18($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = new XMLHttpRequest();
    var $v_1 = '';
    var $v_2 = $p0.clvp;
    var $v_3 = SP.UI.Discussions.Helpers.$2L($p0);

    switch ($p4) {
    case 3:
        SP.UI.Discussions.AsyncRefreshRequest.$a = null;
        break;
    case 1:
        SP.UI.Discussions.AsyncRefreshRequest.$a = $p0.ListData['NextHref'];
        break;
    case 2:
        SP.UI.Discussions.AsyncRefreshRequest.$a = $p0.ListData['PrevHref'];
        break;
    case 0:
        break;
    default:
    ...
    var $v_4 = SP.UI.Discussions.AsyncRefreshRequest.$a;
    ...
    if ($p1) {
        $v_5 = SP.UI.Discussions.Helpers.$1f($p0, String.format('<Query><Where><Eq><FieldRef Name=\"ID\"/><Value Type=\"Number\">{0}</Value></Eq></Where></Query>', $p2));
    }
...
SP.UI.Discussions.AsyncRefreshRequest.prototype = {
    ...
    start: function SP_UI_Discussions_AsyncRefreshRequest$start() {
        if (!this.$25_0) {
            this.$O_0.onreadystatechange = this.$$d_$2l_0;
            this.$O_0.send(this.$1o_0);
            this.$25_0 = true;
        }
    },
    $2U_0: function SP_UI_Discussions_AsyncRefreshRequest$$2U_0($p0) {
        if (this.$F_0) {
            this.$F_0(this, $p0);
        }
        this.$F_0 = null;
    },
    $1J_0: function SP_UI_Discussions_AsyncRefreshRequest$$1J_0($p0) {
        if (this.$H_0) {
            this.$H_0(this, $p0);
        }
        this.$H_0 = null;
    },
    $2l_0: function SP_UI_Discussions_AsyncRefreshRequest$$2l_0() {
        if (this.$O_0.readyState === 4) {
            this.$O_0.onreadystatechange = null;
            if (this.$O_0.status === 601) {
                this.$1J_0(this.$O_0.responseText);
            }
            else {
...
SP.UI.Discussions.ForumRenderer.prototype = {
    ...
    createRenderingContextOverrides: function SP_UI_Discussions_ForumRenderer$createRenderingContextOverrides() {
        ...
        $v_0.OnPreRender = this.$$d_$1k_0;
        $v_0.OnPostRender = this.$$d_$2a_0;
        return $v_0;
    },
    ...
    $2a_0: function SP_UI_Discussions_ForumRenderer$$2a_0($p0) {
        this.attachEvents($p0);
        SP.ScriptHelpers.disableWebpartSelection($p0);
    },
    $1k_0: function SP_UI_Discussions_ForumRenderer$$1k_0($p0) {
        if (!SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty($p0.ListData['FilterLink'])) {
            ...
            if ($v_1) {
                $v_2 = SP.ScriptHelpers.replaceOrAddQueryString($v_2, 'SortField', $v_1.$d_0);
                $v_2 = SP.ScriptHelpers.replaceOrAddQueryString($v_2, 'SortDir', $v_1.$19_0);
            }
    ...
    renderForumPost: function SP_UI_Discussions_ForumRenderer$renderForumPost(context) {
        ...
        $v_1.addNewPost($v_2);
        var $v_3 = SP.UI.Discussions.PostBehavior.RenderOptions.get_$26();
...
SP.UI.Discussions.ForumViewState.prototype = {
    ...
    initialize: function SP_UI_Discussions_ForumViewState$initialize() {
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefined(this.$f_0)) {
            this.$f_0.attachEvents();
        }
        if (!SP.UI.Discussions.Helpers.$L(this.$0_0) && !SP.UI.Discussions.Helpers.isNullOrUndefined(this.$0_0.ListSchema.ListRight_AddListItems)) {
            ...
            this.$e_0 = new SP.UI.Discussions.ReplyBoxControl($v_2, 'Footer', true, false, false);
            this.$e_0.show(false);
        }
            ...
            if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_3)) {
                for (var $v_4 = 0, $v_5 = $v_3.length; $v_4 < $v_5; $v_4++) {
                    ...
                    if (!SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty($v_7) && $v_7.startsWith('RefreshPageTo')) {
                        ...
                        var $v_A = $v_9 ? this.$$d_$2Z_0 : this.$$d_$2Y_0;
    ...
    $l_0: function SP_UI_Discussions_ForumViewState$$l_0($p0) {
        ...
        $v_1.$F_0 = $v_0.$$d_onQueryCompleted;
        $v_1.$H_0 = $v_0.$$d_onQueryFailed;
        $v_1.start();
    },
    refreshSinglePost: function SP_UI_Discussions_ForumViewState$refreshSinglePost(postID) {
        ...
        $v_0.$F_0 = this.$$d_$2d_0;
        $v_0.$H_0 = this.$$d_$2e_0;
        $v_0.start();
    },
    ...
    $29_0: function SP_UI_Discussions_ForumViewState$$29_0() {
        var $v_0 = 0;
    ...
    $1a_0: function SP_UI_Discussions_ForumViewState$$1a_0($p0) {
        var $v_0 = SP.UI.Discussions.Helpers.$2G(this.$E_0, 'PostList');
    ...
    $2Y_0: function SP_UI_Discussions_ForumViewState$$2Y_0($p0) {
        $p0.preventDefault();
        this.$l_0(1);
    },
    ...
    $2d_0: function SP_UI_Discussions_ForumViewState$$2d_0($p0, $p1) {
        this.$32_0($p1, $p0.$1G_0);
    },
    $2e_0: function SP_UI_Discussions_ForumViewState$$2e_0($p0, $p1) {
        SP.UI.Discussions.Helpers.showScriptError($p1);
    },
    $21_0: function SP_UI_Discussions_ForumViewState$$21_0($p0) {
        ...
        if ($v_0) {
            ...
            if (this.$e_0) {
                this.$e_0.transferState($v_2.$e_0);
            }
            $v_2.$29_0();
        }
    },
    $32_0: function SP_UI_Discussions_ForumViewState$$32_0($p0, $p1) {
        var $v_0 = $p0['Row'];
        var $v_1 = null;
                ...
                if ($v_9.get_itemID() === $p1) {
                    if ($v_9.get_isRenderedByRootPost()) {
                        ...
                        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_C)) {
                            ...
                            $v_D.render($v_E, SP.UI.Discussions.PostBehavior.RenderOptions.get_$1Z());
...
SP.UI.Discussions.ForumViewState.DeferredAnimatedRefreshHandler.prototype = {
    ...
    $1E_0: function SP_UI_Discussions_ForumViewState_DeferredAnimatedRefreshHandler$$1E_0() {
        if (!this.$14_0 && !this.$1Y_0 && this.$p_0) {
            this.$p_0(this.$1P_0, this.$v_0);
        }
    }
};
...
SP.UI.Discussions.GlobalTemplateOverrides.$$cctor = function SP_UI_Discussions_GlobalTemplateOverrides$$$cctor() {
    ...
    for (var $$arr_0 = SP.UI.Discussions.GlobalTemplateOverrides.$23, $$len_1 = $$arr_0.length, $$idx_2 = 0; $$idx_2 < $$len_1; ++$$idx_2) {
        var $v_1 = $$arr_0[$$idx_2];
        var $v_2;
...
SP.UI.Discussions.HeaderBehavior = function SP_UI_Discussions_HeaderBehavior(context) {
    ...
    this.$1I_0 = SP.UI.Discussions.Helpers.$J(this.context.forumViewState.$E_0, 'NewPostLink');
    this.$1O_0 = SP.UI.Discussions.Helpers.$J(this.context.forumViewState.$E_0, 'RefreshLink');
...
SP.UI.Discussions.HeaderBehavior.prototype = {
    ...
    attachEvents: function SP_UI_Discussions_HeaderBehavior$attachEvents() {
        var $v_0 = $get(this.$1I_0);

        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_0)) {
            $addHandler($v_0, 'click', this.$$d_onClickNewPostLink);
        }
        var $v_1 = $get(this.$1O_0);

        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_1)) {
            $addHandler($v_1, 'click', this.$$d_$2T_0);
        }
    ...
    render: function SP_UI_Discussions_HeaderBehavior$render(builder) {
        if (!SP.UI.Discussions.Helpers.isAnonymousAccess(this.context)) {
            ...
            builder.addAttribute('id', this.$1I_0);
        ...
        builder.renderBeginTag('div');
        this.sortFilterPickerControl.$1A_0 = true;
        this.sortFilterPickerControl.render(builder);
        builder.addAttribute('id', this.$1O_0);
    ...
    $2T_0: function SP_UI_Discussions_HeaderBehavior$$2T_0($p0) {
        $p0.preventDefault();
...
SP.UI.Discussions.Helpers.$1d = function SP_UI_Discussions_Helpers$$1d($p0, $p1) {
...
SP.UI.Discussions.Helpers.$2G = function SP_UI_Discussions_Helpers$$2G($p0, $p1) {
...
SP.UI.Discussions.Helpers.$2L = function SP_UI_Discussions_Helpers$$2L($p0) {
    var $v_0 = $p0.clvp;
...
SP.UI.Discussions.Helpers.$m = function SP_UI_Discussions_Helpers$$m() {
...
SP.UI.Discussions.ManagementViewRenderer.prototype = {
    ...
    $1k_0: function SP_UI_Discussions_ManagementViewRenderer$$1k_0($p0) {
...
SP.UI.Discussions.PostBehavior = function SP_UI_Discussions_PostBehavior(context, jsonItem) {
    ...
    if (this.$4_0) {
        ...
        if (this.$0_0.ListData['Row'].length > 1) {
            ...
            this.repliesSortPicker.$13_0 = true;
...
SP.UI.Discussions.PostBehavior.prototype = {
    ...
    get_$1j_0: function SP_UI_Discussions_PostBehavior$get_$1j_0() {
        return this.$j_0;
    },
    set_$1j_0: function SP_UI_Discussions_PostBehavior$set_$1j_0($p0) {
        if (this.$j_0 !== $p0) {
            this.$j_0 = $p0;
            this.$1X_0();
        }
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_0)) {
            ...
            window.setTimeout(function() {
                ...
                if ($$t_3.$1H_0) {
                    ...
                    if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_1)) {
                        $v_1.style.width = '0px';
                        SPAnimationUtility.BasicAnimator.Resize($v_1, null, $$t_3.$x_0, null, null);
                    }
                    $$t_3.$1H_0 = false;
                }
            }, deferTime);
    ...
    initialize: function SP_UI_Discussions_PostBehavior$initialize() {
        ...
        if (this.get_bestResponseIsVisible()) {
            ...
            var $v_1 = SP.UI.Discussions.Helpers.$1e(this.$0_0, $v_0);
        ...
        if (this.$4_0 && !SP.UI.Discussions.Helpers.$L(this.$0_0)) {
            ...
            if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_2)) {
                $addHandler($v_2, 'click', this.$$d_$2X_0);
            }
    ...
    getPostElementID: function SP_UI_Discussions_PostBehavior$getPostElementID(elementID) {
        return SP.UI.Discussions.Helpers.$J(this.$0_0.forumViewState.$E_0, 'Post' + this.$1p_0 + '-' + elementID);
    },
    ...
    render: function SP_UI_Discussions_PostBehavior$render(builder, renderOptions) {
        ...
        if (SP.UI.Discussions.PostBehavior.DiscussionHelpers.$1N) {
            SP.UI.Discussions.PostBehavior.DiscussionHelpers.$31();
            SP.UI.Discussions.PostBehavior.DiscussionHelpers.$1N = false;
        }
        if (SP.UI.Discussions.Helpers.$L(this.$0_0)) {
            this.$2v_0(builder, renderOptions);
        }
        else {
            this.$1z_0(builder, renderOptions);
        }
    },
    ...
    $2H_0: function SP_UI_Discussions_PostBehavior$$2H_0() {
        var $v_0 = new SP.HtmlBuilder();
    ...
    $2C_0: function SP_UI_Discussions_PostBehavior$$2C_0() {
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_0)) {
            ...
            EnsureScriptFunc('callout.js', 'CalloutManager', function() {
                ...
                $v_2.onOpeningCallback = $$t_4.$$d_$2Q_0;
                try {
    ...
    $1z_0: function SP_UI_Discussions_PostBehavior$$1z_0($p0, $p1) {
        this.$0_0.CurrentItem = this.jsonItem;
        if ($p1.get_$r_0()) {
        ...
        if (this.$4_0) {
            ...
            this.$1y_0($p0, 'ms-metadata ms-comm-statsInlineContainer', 'ms-comm-statsInline', 'ms-comm-reputationNumbers');
            $p0.renderEndTag();
        }
        if (!this.get_$B_0()) {
            if (this.$4_0) {
            ...
            $p0.renderEndTag();
            $p0.renderEndTag();
            if ($p1.get_$1Q_0() && this.get_bestResponseIsVisible()) {
    ...
    $2v_0: function SP_UI_Discussions_PostBehavior$$2v_0($p0, $p1) {
        ...
        $p0.renderBeginTag('div');
        this.$20_0($p0, true, $p1);
        this.$1s_0($p0, true, $p1);
    ...
    $2O_0: function SP_UI_Discussions_PostBehavior$$2O_0($p0, $p1) {
        var $v_0 = this.jsonItem['BestAnswerId'];
        var $v_1 = $p1['Row'];
    ...
    $2Q_0: function SP_UI_Discussions_PostBehavior$$2Q_0($p0) {
        if (SP.UI.Discussions.Helpers.doesSchemaContainField(this.$0_0.ListSchema, 'ParentItemID') && !SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty(this.jsonItem['ParentItemID'])) {
            ...
            if (!this.$P_0) {
                this.$P_0 = SP.UI.Discussions.Helpers.$1e(this.$0_0, $v_0);
            }
            if (!this.$P_0) {
                var $v_1 = SP.UI.Discussions.AsyncRefreshRequest.createSingleItemRefreshRequest(this.$0_0, $v_0);

                $v_1.$F_0 = this.$$d_$2R_0;
                $v_1.$H_0 = this.$$d_$2P_0;
                $v_1.start();
            }
            else {
                this.$1t_0();
    ...
    $2R_0: function SP_UI_Discussions_PostBehavior$$2R_0($p0, $p1) {
        var $v_0 = this.jsonItem['ParentItemID'];
        var $v_1 = $p1['Row'];
    ...
    $2p_0: function SP_UI_Discussions_PostBehavior$$2p_0() {
        var $v_0 = this.jsonItem['BestAnswerId'];
        var $v_1 = SP.UI.Discussions.AsyncRefreshRequest.createSingleItemRefreshRequest(this.$0_0, $v_0);

        $v_1.$F_0 = this.$$d_$2O_0;
        $v_1.$H_0 = this.$$d_$2P_0;
        $v_1.start();
    },
    ...
    $1s_0: function SP_UI_Discussions_PostBehavior$$1s_0($p0, $p1, $p2) {
        if ($p1) {
            if (!SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty(this.jsonItem['Body'])) {
                var $v_0;
                var $$t_6, $$t_7;
                var $v_1 = ($$t_7 = SP.UI.Discussions.Helpers.checkForImageAndRemoveHtml(this.jsonItem['Body'], $$t_6 = {
                    'val': $v_0
                }), $v_0 = $$t_6.val, $$t_7);
            ...
            if (this.$j_0) {
                ...
                var $v_2 = SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty(this.jsonItem['TrimmedBody']) ? 'Body' : 'TrimmedBody';

                $p0.write(spMgr.RenderFieldByName(this.$0_0, $v_2, this.jsonItem, this.$0_0.ListSchema));
            }
            $p0.renderEndTag();
        }
    },
    $20_0: function SP_UI_Discussions_PostBehavior$$20_0($p0, $p1, $p2) {
        if (this.$4_0) {
            if ($p1) {
    ...
    $2W_0: function SP_UI_Discussions_PostBehavior$$2W_0($p0) {
    ...
    $2f_0: function SP_UI_Discussions_PostBehavior$$2f_0($p0) {
    ...
    $1Q_0: function SP_UI_Discussions_PostBehavior$$1Q_0() {
        var $v_0 = new SP.HtmlBuilder();

        this.$0_0.CurrentItem = this.$D_0.jsonItem;
        this.$D_0.$1z_0($v_0, new SP.UI.Discussions.PostBehavior.RenderOptions(false, false, true, true, true, true, true));
    ...
    $1t_0: function SP_UI_Discussions_PostBehavior$$1t_0() {
        var $v_0 = new SP.HtmlBuilder();
    ...
    $1v_0: function SP_UI_Discussions_PostBehavior$$1v_0($p0) {
    ...
    $2x_0: function SP_UI_Discussions_PostBehavior$$2x_0($p0) {
        ...
        $p0.renderBeginTag('div');
        $p0.renderEndTag();
        var $v_4 = this.$2K_0(Number.parseInvariant($v_1), Number.parseInvariant($v_2), $v_3 ? 1 : 0);
        ...
        $p0.addAttribute('style', 'width: ' + this.$x_0 + 'px; ');
        $p0.renderBeginTag('span');
        $p0.addCssClass('ms-positionAbsolute');
        $p0.addAttribute('src', SP.UI.Discussions.PostBehavior.ImageUrls.$1L);
        $p0.renderBeginTag('img');
        $p0.renderEndTag();
        $p0.renderEndTag();
        $p0.addCommunitiesCssClass('popularityBarShadow');
        $p0.addAttribute('style', 'width: ' + (90 - this.$x_0) + 'px;');
        $p0.renderBeginTag('span');
        $p0.addCssClass('ms-positionAbsolute');
        ...
        $p0.renderBeginTag('div');
        $p0.renderEndTag();
        this.$1y_0($p0, 'ms-metadata', 'ms-comm-stats', 'ms-comm-reputationNumbers');
        $p0.renderEndTag();
    },
    $2K_0: function SP_UI_Discussions_PostBehavior$$2K_0($p0, $p1, $p2) {
    ...
    $1y_0: function SP_UI_Discussions_PostBehavior$$1y_0($p0, $p1, $p2, $p3) {
        $p0.addCssClass($p1);
        $p0.renderBeginTag('div');
        $p0.addCssClass($p2);
        $p0.renderBeginTag('div');
    ...
    $1X_0: function SP_UI_Discussions_PostBehavior$$1X_0() {
        var $v_0 = null;
        ...
        this.render($v_1, SP.UI.Discussions.PostBehavior.RenderOptions.get_$1Z());
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty($v_0)) {
            ...
            if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_3)) {
                SP.UI.Discussions.Helpers.$1d(this.$0_0, $v_3);
            }
        }
    }
};
SP.UI.Discussions.PostBehavior.RenderOptions = function SP_UI_Discussions_PostBehavior_RenderOptions(includeRootElement, includeMainContainer, renderCommandSpace, renderReplyToLink, overflowStyle, showExpandCollapseButton, renderBestResponse) {
    this.$1i_0 = includeRootElement;
    this.$1g_0 = includeMainContainer;
    this.$1u_0 = renderCommandSpace;
    this.$1x_0 = renderReplyToLink;
    this.$1n_0 = overflowStyle;
    this.$22_0 = showExpandCollapseButton;
    this.$1r_0 = renderBestResponse;
};
SP.UI.Discussions.PostBehavior.RenderOptions.get_$26 = function SP_UI_Discussions_PostBehavior_RenderOptions$get_$26() {
    return new SP.UI.Discussions.PostBehavior.RenderOptions(true, true, true, true, true, true, true);
};
SP.UI.Discussions.PostBehavior.RenderOptions.get_$1Z = function SP_UI_Discussions_PostBehavior_RenderOptions$get_$1Z() {
...
SP.UI.Discussions.PostBehavior.RenderOptions.prototype = {
    ...
    renderDate: false,
    get_$r_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$r_0() {
        return this.$1i_0;
    },
    get_$1h_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$1h_0() {
        return this.$1g_0;
    },
    get_$1v_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$1v_0() {
        return this.$1u_0;
    },
    get_$30_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$30_0() {
        return this.$1x_0;
    },
    get_$2o_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$2o_0() {
        return this.$1n_0;
    },
    get_$33_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$33_0() {
        return this.$22_0;
    },
    get_$1Q_0: function SP_UI_Discussions_PostBehavior_RenderOptions$get_$1Q_0() {
        return this.$1r_0;
    }
};
...
SP.UI.Discussions.PostBehavior.DiscussionHelpers.$31 = function SP_UI_Discussions_PostBehavior_DiscussionHelpers$$31() {
    SP.UI.Discussions.PostBehavior.ImageUrls.$1L = GetThemedImageUrl('PopularityBar.png');
    SP.UI.Discussions.PostBehavior.ImageUrls.$1M = GetThemedImageUrl('PopularityBarShadow.png');
};
...
SP.UI.Discussions.PostAction.prototype = {
    ...
    transferState: function SP_UI_Discussions_PostAction$transferState(destAction) {
        if (this.get_linkElement() === this.$1_1.$0_0.forumViewState.get_activeElement()) {
            SP.UI.Discussions.Helpers.$1d(this.$1_1.$0_0, destAction.get_linkElement());
        }
    }
};
...
SP.UI.Discussions.DeleteAction.prototype = {
    onClick: function SP_UI_Discussions_DeleteAction$onClick() {
        if (confirm(Strings.STS.L_SPDiscDeleteConfirm)) {
            ...
            $v_0.executeQueryAsync(this.$$d_$2c_2, this.$$d_$2b_2);
        }
    },
    ...
    $2b_2: function SP_UI_Discussions_DeleteAction$$2b_2($p0, $p1) {
...
SP.UI.Discussions.AlertMeAction.prototype = {
    onClick: function SP_UI_Discussions_AlertMeAction$onClick() {
        ...
        var $v_1 = 'ID=' + escapeProperlyCore('' + this.$1_1.get_itemID(), false) + '&List=' + this.$1_1.$0_0.listName + '&' + 'Source' + '=' + escapeProperlyCore($v_0.get_href(), false);
...
SP.UI.Discussions.SetBestResponseAction = function SP_UI_Discussions_SetBestResponseAction($p0, $p1) {
    this.$$d_$1J_2 = Function.createDelegate(this, this.$1J_2);
...
SP.UI.Discussions.SetBestResponseAction.prototype = {
    ...
    get_tooltip: function SP_UI_Discussions_SetBestResponseAction$get_tooltip() {
        return this.$1W_2 ? Strings.STS.L_SPDiscBestUndoTooltip : Strings.STS.L_SPDiscBestTooltip;
    },
    onClick: function SP_UI_Discussions_SetBestResponseAction$onClick() {
        ...
        if ($v_0) {
            ...
            $v_4.update();
            $v_2.executeQueryAsync(this.$$d_$1l_2, this.$$d_$1J_2);
            this.set_isEnabled(false);
        }
    },
    $1l_2: function SP_UI_Discussions_SetBestResponseAction$$1l_2($p0, $p1) {
        SP.UI.Discussions.Helpers.refreshCurrentPage(this.$1_1.$0_0);
        this.set_isEnabled(true);
    },
    $1J_2: function SP_UI_Discussions_SetBestResponseAction$$1J_2($p0, $p1) {
        SP.UI.Discussions.Helpers.showScriptError($p1.get_message());
        this.set_isEnabled(true);
    }
};
...
SP.UI.Discussions.MarkAsFeaturedAction.prototype = {
    ...
    get_tooltip: function SP_UI_Discussions_MarkAsFeaturedAction$get_tooltip() {
        return this.$1F_2 === '1' ? Strings.STS.L_SPDiscUnmarkAsFeaturedTooltip : Strings.STS.L_SPDiscMarkAsFeaturedTooltip;
    },
    onClick: function SP_UI_Discussions_MarkAsFeaturedAction$onClick() {
        ...
        $v_0.executeQueryAsync(this.$$d_$1l_2, this.$$d_$1J_2);
        this.set_isEnabled(false);
    },
    $1l_2: function SP_UI_Discussions_MarkAsFeaturedAction$$1l_2($p0, $p1) {
        SP.UI.Discussions.Helpers.refreshCurrentPage(this.$1_1.$0_0);
        this.set_isEnabled(true);
    },
    $1J_2: function SP_UI_Discussions_MarkAsFeaturedAction$$1J_2($p0, $p1) {
        SP.UI.Discussions.Helpers.showScriptError($p1.get_message());
        this.set_isEnabled(true);
    }
};
SP.UI.Discussions.ReplyBoxControl = function SP_UI_Discussions_ReplyBoxControl($p0, $p1, $p2, $p3, $p4) {
    ...
    this.$1S_0 = this.$$d_$2h_0;
    this.$17_0 = this.$$d_$2g_0;
};
SP.UI.Discussions.ReplyBoxControl.prototype = {
    ...
    get_$16_0: function SP_UI_Discussions_ReplyBoxControl$get_$16_0() {
        if (!this.$o_0) {
            this.$o_0 = $get(this.$8_0('ReplyCancel'));
        }
        return this.$o_0;
    },
    get_$3_0: function SP_UI_Discussions_ReplyBoxControl$get_$3_0() {
        if (!this.$Z_0 || !this.$Z_0.parentNode) {
            this.$Z_0 = $get(this.$8_0(this.$c_0 ? 'EditContainer' : 'ReplyContainer'));
        }
        return this.$Z_0;
    },
    get_$i_0: function SP_UI_Discussions_ReplyBoxControl$get_$i_0() {
        return this.$15_0;
    },
    set_$i_0: function SP_UI_Discussions_ReplyBoxControl$set_$i_0($p0) {
        if (this.$15_0 !== $p0) {
            this.$15_0 = $p0;
            this.$34_0();
            this.$12_0();
    ...
    get_$1R_0: function SP_UI_Discussions_ReplyBoxControl$get_$1R_0() {
        if (!this.$z_0) {
            this.$z_0 = $get(this.$8_0('ReplySubmit'));
        }
        return this.$z_0;
    },
    get_$2_0: function SP_UI_Discussions_ReplyBoxControl$get_$2_0() {
        if (!this.$11_0) {
            this.$11_0 = $get(this.$8_0('RichTextArea'));
        }
        return this.$11_0;
    },
    ...
    $27_0: function SP_UI_Discussions_ReplyBoxControl$$27_0() {
    ...
    $2A_0: function SP_UI_Discussions_ReplyBoxControl$$2A_0() {
        RTE.CanvasEvents.registerListener(RTE.CanvasEvents.editableRegionChangedEvent, this.$1U_0);
        $addHandler(this.get_$2_0(), 'focus', this.$1V_0);
        RTE.CanvasEvents.registerListener(RTE.CanvasEvents.editableRegionBlurEvent, this.$1T_0);
        $addHandler(this.get_$1R_0(), 'click', this.$1S_0);
        if (this.$S_0) {
            $addHandler(this.get_$16_0(), 'click', this.$17_0);
        }
    },
    $2B_0: function SP_UI_Discussions_ReplyBoxControl$$2B_0($p0, $p1) {
    ...
    $2D_0: function SP_UI_Discussions_ReplyBoxControl$$2D_0() {
        RTE.CanvasEvents.unRegisterListener(RTE.CanvasEvents.editableRegionChangedEvent, this.$1U_0);
        $removeHandler(this.get_$2_0(), 'focus', this.$1V_0);
        RTE.CanvasEvents.unRegisterListener(RTE.CanvasEvents.editableRegionBlurEvent, this.$1T_0);
        $removeHandler(this.get_$1R_0(), 'click', this.$1S_0);
        if (this.$S_0) {
            $removeHandler(this.get_$16_0(), 'click', this.$17_0);
        }
    },
    $8_0: function SP_UI_Discussions_ReplyBoxControl$$8_0($p0) {
        ...
        if (!this.$1K_0) {
            ...
            $v_0 = SP.UI.Discussions.Helpers.$J(this.$1_0.$0_0.forumViewState.$E_0, this.$1K_0 + '-' + $p0);
        }
        return $v_0;
    },
    $2M_0: function SP_UI_Discussions_ReplyBoxControl$$2M_0() {
        var $v_0 = '';
    ...
    $2g_0: function SP_UI_Discussions_ReplyBoxControl$$2g_0($p0) {
        $p0.preventDefault();
        this.hide(false);
    },
    $2h_0: function SP_UI_Discussions_ReplyBoxControl$$2h_0($p0) {
        ...
        this.$k_0 = SP.UI.Notify.addNotification(Strings.STS.L_Loading_Text, false);
        this.set_$i_0(true);
        $v_0.executeQueryAsync(this.$$d_$2n_0, this.$$d_$2m_0);
    },
    ...
    $2k_0: function SP_UI_Discussions_ReplyBoxControl$$2k_0($p0) {
        this.$G_0 = true;
        this.$n_0(true);
    },
    $2i_0: function SP_UI_Discussions_ReplyBoxControl$$2i_0($p0, $p1) {
    ...
    $2n_0: function SP_UI_Discussions_ReplyBoxControl$$2n_0($p0, $p1) {
        ...
        if (!SP.ScriptHelpers.isNullOrUndefinedOrEmpty(this.$k_0)) {
            SP.UI.Notify.removeNotification(this.$k_0);
        }
    },
    $2m_0: function SP_UI_Discussions_ReplyBoxControl$$2m_0($p0, $p1) {
        SP.UI.Discussions.Helpers.showScriptError($p1.get_message());
        this.set_$i_0(false);
        if (!SP.ScriptHelpers.isNullOrUndefinedOrEmpty(this.$k_0)) {
            SP.UI.Notify.removeNotification(this.$k_0);
    ...
    $1m_0: function SP_UI_Discussions_ReplyBoxControl$$1m_0() {
        if (this.$W_0) {
            this.$W_0(this);
        }
    },
    $1q_0: function SP_UI_Discussions_ReplyBoxControl$$1q_0() {
        this.$o_0 = null;
        this.$Z_0 = null;
        this.$z_0 = null;
        this.$11_0 = null;
    },
    $2q_0: function SP_UI_Discussions_ReplyBoxControl$$2q_0($p0) {
        var $v_0 = new SP.HtmlBuilder();
        ...
        $v_0.renderBeginTag('div');
        var $v_1 = this.$c_0 ? Strings.STS.L_SPDiscSubmitEditButton : Strings.STS.L_SPDiscSubmitReplyButton;
    ...
    $34_0: function SP_UI_Discussions_ReplyBoxControl$$34_0() {
        if (this.$7_0 && this.$S_0) {
            (this.get_$16_0()).disabled = this.get_$i_0();
        }
    },
    $12_0: function SP_UI_Discussions_ReplyBoxControl$$12_0() {
        if (this.$7_0) {
            (this.get_$1R_0()).disabled = !((this.get_textValue()).length > 0) || SP.ScriptHelpers.removeHtml(this.get_textValue()) === Strings.STS.L_SPDiscReplyPlaceholder || !this.$G_0 || this.get_$i_0();
        }
    },
    $n_0: function SP_UI_Discussions_ReplyBoxControl$$n_0($p0) {
...
SP.UI.Discussions.SortFilterPickerControl = function SP_UI_Discussions_SortFilterPickerControl() {
    ...
    SP.UI.Discussions.SortFilterPickerControl.$1C[this.$5_0] = this;
...
SP.UI.Discussions.SortFilterPickerControl.onMenuItemClick = function SP_UI_Discussions_SortFilterPickerControl$onMenuItemClick(controlElementID, itemIndex) {
    var $v_0 = SP.UI.Discussions.SortFilterPickerControl.$1C[controlElementID];
...
SP.UI.Discussions.SortFilterPickerControl.prototype = {
    ...
    initialize: function SP_UI_Discussions_SortFilterPickerControl$initialize() {
        if (!this.$V_0) {
            this.$w_0 = new ClientPivotControl();
            this.$w_0.PivotParentId = this.$5_0;
            for (var $v_0 = 0, $v_1 = this.$C_0.length; $v_0 < $v_1; $v_0++) {
                var $v_2 = this.$C_0[$v_0];

                this.$w_0.AddMenuOption($v_2.$2F_0());
            }
            this.$w_0.Render();
        }
        else if (this.$V_0 === 1) {
            ...
            if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_3)) {
                $addHandler($v_3, 'click', this.$$d_$2V_0);
            }
        }
    },
    ...
    $2E_0: function SP_UI_Discussions_SortFilterPickerControl$$2E_0() {
        if (!this.$q_0) {
            this.$q_0 = SP.UI.Menu.create(this.$5_0 + '-menu');
            for (var $v_0 = 0, $v_1 = this.$C_0.length; $v_0 < $v_1; $v_0++) {
                var $v_2 = this.$C_0[$v_0];

                this.$q_0.addMenuItem($v_2.$b_0, 'SP.UI.Discussions.SortFilterPickerControl.onMenuItemClick(\'' + this.$5_0 + '\',' + $v_0 + ');', null, null, $v_0, null, null);
            }
        }
    },
    $2V_0: function SP_UI_Discussions_SortFilterPickerControl$$2V_0($p0) {
        $p0.preventDefault();
        $p0.stopPropagation();
        var $v_0 = $get(this.$5_0);
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_0)) {
            this.$2E_0();
            this.$q_0.show($v_0, false, false, -1);
        }
    },
    ...
    $1w_0: function SP_UI_Discussions_SortFilterPickerControl$$1w_0($p0, $p1) {
        switch (this.$V_0) {
        case 0:
            this.$2w_0($p0);
            break;
    ...
    $2t_0: function SP_UI_Discussions_SortFilterPickerControl$$2t_0($p0) {
        var $v_0 = this.$5_0;
...
SP.UI.Discussions.SortFilterItem = function SP_UI_Discussions_SortFilterItem(context, displayName) {
    ...
    this.$t_0 = 'javascript:;';
    this.$M_0 = false;
    this.$5_0 = 'SortItem' + SP.UI.Discussions.SortFilterItem.$1B;
    SP.UI.Discussions.SortFilterItem.$1D[this.$5_0] = this;
    SP.UI.Discussions.SortFilterItem.$1B++;
};
SP.UI.Discussions.SortFilterItem.onPivotControlMenuOptionClick = function SP_UI_Discussions_SortFilterItem$onPivotControlMenuOptionClick(elementID) {
    var $v_0 = SP.UI.Discussions.SortFilterItem.$1D[elementID];
...
SP.UI.Discussions.SortFilterItem.prototype = {
    ...
    attachEvents: function SP_UI_Discussions_SortFilterItem$attachEvents() {
        ...
        if (!SP.UI.Discussions.Helpers.isNullOrUndefined($v_0)) {
            $addHandler($v_0, 'click', this.$$d_$2S_0);
        }
    },
    onClick: function SP_UI_Discussions_SortFilterItem$onClick() {
        STSNavigate(this.$t_0);
    },
    $2S_0: function SP_UI_Discussions_SortFilterItem$$2S_0($p0) {
        $p0.preventDefault();
        this.onClick();
    },
    $2F_0: function SP_UI_Discussions_SortFilterItem$$2F_0() {
        var $v_0 = new ClientPivotControlMenuOption();

        $v_0.DisplayText = this.$b_0;
...
SP.UI.Discussions.ViewSwitchItem.prototype = {
    ...
    onClick: function SP_UI_Discussions_ViewSwitchItem$onClick() {
        ...
        this.$0_0.forumViewState.switchToNewView(this.$T_1, this.$24_1);
    }
};
SP.UI.Discussions.QueryOverrideItem = function SP_UI_Discussions_QueryOverrideItem(context, displayName, queryOverride) {
    ...
    this.$y_1 = SP.UI.Discussions.Helpers.$1f(context, queryOverride);
    this.$M_0 = context.overrideSelectCommand === this.$y_1;
    if (SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty(context.overrideSelectCommand) && SP.UI.Discussions.Helpers.isNullOrUndefinedOrEmpty(this.$y_1)) {
        this.$M_0 = true;
    }
};
SP.UI.Discussions.QueryOverrideItem.prototype = {
    ...
    onClick: function SP_UI_Discussions_QueryOverrideItem$onClick() {
        this.$0_0.overrideSelectCommand = this.$y_1;
        this.$0_0.forumViewState.$l_0(3);
    }
};
...
function sp_ui_discussions_initialize() {
    ...
    SP.UI.Discussions.GlobalTemplateOverrides.$23 = [2, 3, 7];
    SP.UI.Discussions.GlobalTemplateOverrides.$$cctor();
    SP.UI.Discussions.PostBehavior.$K = 0;
    SP.UI.Discussions.PostBehavior.ImageUrls.$1L = '';
    SP.UI.Discussions.PostBehavior.ImageUrls.$1M = '';
    SP.UI.Discussions.PostBehavior.DiscussionHelpers.$1N = true;
    SP.UI.Discussions.SortFilterPickerControl.$K = 0;
    SP.UI.Discussions.SortFilterPickerControl.$1C = {};
    SP.UI.Discussions.SortFilterItem.$1B = 1;
    SP.UI.Discussions.SortFilterItem.$1D = {};
