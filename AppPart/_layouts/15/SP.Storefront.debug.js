...
SP.Storefront.AppDetailsView = function SP_Storefront_AppDetailsView() {
    ...
    this.$1j_3 = SP.ScriptUtility.emptyString;
    ...
    this.$1a_3 = document.createElement('span');
    Sys.UI.DomElement.addCssClass(this.$1a_3, 'ms-storefront-appdetailstrialmsg');
    Sys.UI.DomElement.addCssClass(this.$1a_3, 'ms-metadata');
    $v_5.appendChild(this.$1a_3);
...
SP.Storefront.AppDetailsView.prototype = {
    ...
    $5O_3: function SP_Storefront_AppDetailsView$$5O_3() {
        ...
        this.$1l_3 = this.$9_3 && (this.get_appMetadataDetail()).get_trial() !== 0;
        this.$e_3 = !this.$14_3;
        ...
        this.$1g_3 = this.$2w_3 && ((this.get_appMetadataDetail()).get_manageableLicense()).get_isTokenExpired();
    ...
    $5n_3: function SP_Storefront_AppDetailsView$$5n_3() {
        ...
        var $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_Version);

        SP.UI.UIUtility.setInnerText($v_1, ((this.get_appMetadataDetail()).get_basicDetails()).get_version());
        if (this.$e_3) {
            $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_Rating);
            ...
            $v_1.appendChild($v_4);
            $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_Downloads);
            SP.UI.UIUtility.setInnerText($v_1, SP.Storefront.StorefrontApp.htmlEncodeWithDefaultFallback((this.get_appMetadataDetail()).get_downloads(), Number));
        }
        $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_ReleaseDate);
        ...
        if (!SP.ScriptUtility.isNullOrEmptyString(((this.get_appMetadataDetail()).get_basicDetails()).get_categoryID())) {
            $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_Category);
        ...
        if (!this.$1p_3 && !SP.ScriptUtility.isNullOrEmptyString((this.get_appMetadataDetail()).get_supportUrl())) {
            ...
            $v_1 = this.$1S_3(SP.Res.storefront_AppDetails_SupportLabel);
            $v_1.appendChild($v_5);
        }
    },
    ...
    $5X_3: function SP_Storefront_AppDetailsView$$5X_3() {
        ...
        if (this.$1N_3()) {
            ...
            else if (this.$1l_3 && !this.$T_3 && SP.Storefront.StorefrontContext.get_isPurchaseOn()) {
                $v_1 = ($v_0 = ($v_2 = false));
            }
        ...
        else if (this.$3N_3() && this.$1l_3 && !this.$T_3 && SP.Storefront.StorefrontContext.get_isPurchaseOn()) {
            $v_1 = ($v_0 = ($v_2 = false));
        }
        ...
        SP.UI.UIUtility.setInnerText(this.$1a_3, SP.Storefront.AppDetailsView.$5j((this.get_appMetadataDetail()).get_trialUsers(), (this.get_appMetadataDetail()).get_trialLength()));
        this.$j_3.set_notDisplayed($v_1);
        this.$j_3.elementObject.disabled = $v_0;
        SP.Storefront.HtmlElement.setDisplayAttribute(this.$1a_3, $v_2);
    ...
    $1S_3: function SP_Storefront_AppDetailsView$$1S_3($p0) {
    ...
    $3s_3: function SP_Storefront_AppDetailsView$$3s_3() {
        this.$8_3.reset();
        this.$1i_3 = ((this.get_appMetadataDetail()).get_basicDetails()).get_price();
        this.$1j_3 = ((this.get_appMetadataDetail()).get_basicDetails()).get_pricePromotion();
        this.$1h_3 = (this.get_appMetadataDetail()).get_pricePercentOff();
    },
    ...
    $2b_3: function SP_Storefront_AppDetailsView$$2b_3($p0) {
        this.$1d_3 = this.$1g_3 ? 3 : 0;
        this.$29_3();
    },
    $5i_3: function SP_Storefront_AppDetailsView$$5i_3($p0) {
        this.$1d_3 = this.$1l_3 && !this.$T_3 ? 2 : 1;
        this.$29_3();
    },
    ...
    $5c_3: function SP_Storefront_AppDetailsView$$5c_3($p0, $p1) {
        ...
        if (!SP.ScriptUtility.isNullOrEmptyString($v_1)) {
            ...
            if (SP.Storefront.SPStorefrontData.toBool($v_0[3])) {
                ...
                this.$1j_3 = $v_0[0];
                this.$1h_3 = $v_0[2];
                this.$21_3(this.$1i_3, this.$1j_3, this.$1h_3);
            }
        }
    },
...
SP.Storefront.AppDetailsHeader = function SP_Storefront_AppDetailsHeader() {
    ...
    this.$1Y_3 = document.createElement('div');
    this.$1Y_3.id = 'idStorefrontProviderLabel';
    Sys.UI.DomElement.addCssClass(this.$1Y_3, 'ms-storefront-appdetailstitle');
    Sys.UI.DomElement.addCssClass(this.$1Y_3, 'ms-textLarge');
    $v_3.appendChild(this.$1Y_3);
};
SP.Storefront.AppDetailsHeader.prototype = {
    ...
    $5r_3: function SP_Storefront_AppDetailsHeader$$5r_3() {
        ...
        SP.Storefront.HtmlElement.setInnerHTML($v_1, this.$1Y_3);
    },
...
SP.Storefront.OfficeAppsView.prototype = {
    ...
    updateUI: function SP_Storefront_OfficeAppsView$updateUI($p0) {
        ...
        if ($p0 || !this.categories.valueEqualsState(this.currentCategory) || $v_1 || $v_0 || !SP.Storefront.StorefrontState.valueEqualsState('qry', this.currentQuery) || !this.$1e_3 || this.header.get_marketSelectionChanged()) {
            this.$2Y_3($p0);
        }
        else {
    ...
    $2Y_3: function SP_Storefront_OfficeAppsView$$2Y_3($p0) {
        ...
        if (!this.$1e_3 || this.header.get_marketSelectionChanged()) {
            this.$5F_3();
...
SP.Storefront.SearchBox.prototype = {
    ...
    $37_2: function SP_Storefront_SearchBox$$37_2() {
        ...
        if (this.$2q_2) {
            Sys.UI.DomElement.addCssClass(this.$I_2, this.$1Z_2 ? 'ms-inlineSearch-cancelImgHover' : 'ms-inlineSearch-searchImgHover');
            ...
            Sys.UI.DomElement.addCssClass(this.$I_2, this.$1Z_2 ? 'ms-inlineSearch-cancelImg' : 'ms-inlineSearch-searchImg');
            Sys.UI.DomElement.addCssClass(this.$n_2, 'ms-inlineSearch-searchImgSpanBase');
...
SP.Storefront.StorefrontApp.get_mainForm = function SP_Storefront_StorefrontApp$get_mainForm() {
    if (SP.ScriptUtility.isNullOrUndefined(SP.Storefront.StorefrontApp.$1U)) {
        SP.Storefront.StorefrontApp.$1U = $get('idStorefrontForm');
    }
    if (SP.ScriptUtility.isNullOrUndefined(SP.Storefront.StorefrontApp.$1U)) {
        var $v_0 = eval('MSOWebPartPageFormName');

        SP.Storefront.StorefrontApp.$1U = $get($v_0);
    }
    return SP.Storefront.StorefrontApp.$1U;
};
...
SP.Storefront.Reviews = function SP_Storefront_Reviews() {
    ...
    this.$1V_2 = document.createElement('div');
    this.appendChild(this.$1V_2);
    this.$1c_2 = document.createElement('div');
    Sys.UI.DomElement.addCssClass(this.$1c_2, 'ms-storefront-floatopposite');
    this.$1V_2.appendChild(this.$1c_2);
    var $v_0 = document.createElement('span');

    Sys.UI.DomElement.addCssClass($v_0, 'ms-storefront-ratespan');
    Sys.UI.DomElement.addCssClass($v_0, 'ms-storefront-float');
    this.$1c_2.appendChild($v_0);
    ...
    this.$1c_2.appendChild(this.$12_2);
    ...
    this.$1V_2.appendChild(this.$J_2.elementObject);
    ...
    this.$1V_2.appendChild(this.$1H_2);
    ...
    this.$1V_2.appendChild(this.$1G_2);
    ...
    this.appendChild($v_6);
    this.$1f_2 = document.createElement('span');
    Sys.UI.DomElement.addCssClass(this.$B_2, 'ms-storefront-centertextinner');
    Sys.UI.DomElement.addCssClass(this.$1f_2, 'ms-storefront-error');
    $v_6.appendChild(this.$1f_2);
};
SP.Storefront.Reviews.prototype = {
    ...
    updateReviewsWithAppMetadata: function SP_Storefront_Reviews$updateReviewsWithAppMetadata($p0) {
        if (this.$2g_2 !== ($p0.get_basicDetails()).get_assetId()) {
            ...
            SP.Storefront.HtmlElement.setDisplayAttribute(this.$1c_2, !$v_0);
    ...
    $5b_2: function SP_Storefront_Reviews$$5b_2($p0, $p1) {
        ...
        if (this.$3j_2(!SP.ScriptUtility.isNullOrUndefined($p1.errorData), this.$1f_2)) {
            var $v_1 = $p1.errorData['Message'];

            if (SP.ScriptUtility.isNullOrEmptyString($v_1)) {
                $v_1 = SP.Res.errorDialogTitleText;
            }
            SP.UI.UIUtility.setInnerText(this.$1f_2, $v_1);
            return;
        }
...
SP.Storefront.PagingControlsWrapper = function SP_Storefront_PagingControlsWrapper($p0) {
    this.$$d_$1d_2 = Function.createDelegate(this, this.$1d_2);
...
SP.Storefront.PagingControlsWrapper.prototype = {
    ...
    $1d_2: function SP_Storefront_PagingControlsWrapper$$1d_2($p0) {
...
SP.Storefront.StorefrontProxy.$1T = function SP_Storefront_StorefrontProxy$$1T($p0, $p1, $p2) {
...
SP.Storefront.StorefrontProxy.prototype = {
    ...
    $1X_1: function SP_Storefront_StorefrontProxy$$1X_1($p0) {
    ...
    $4W_1: function SP_Storefront_StorefrontProxy$$4W_1($p0, $p1) {
        ...
        var $v_1;
        var $v_2;
        var $v_3 = this.$1X_1($p1);
        var $$t_A, $$t_B, $$t_C;

        if (!($$t_C = SP.Storefront.StorefrontProxy.$1T($p1, $$t_A = {
            'val': $v_2
        }, $$t_B = {
            'val': $v_1
    ...
    $4U_1: function SP_Storefront_StorefrontProxy$$4U_1($p0, $p1) {
        ...
        if (!($$t_B = SP.Storefront.StorefrontProxy.$1T($p1, $$t_9 = {
            'val': $v_2
        }, $$t_A = {
            'val': $v_1
    ...
    $4g_1: function SP_Storefront_StorefrontProxy$$4g_1($p0, $p1) {
        ...
        if (!($$t_A = SP.Storefront.StorefrontProxy.$1T($p1, $$t_8 = {
            'val': $v_2
        }, $$t_9 = {
            'val': $v_1
...
function sp_storefront_initialize() {
    ...
    SP.Storefront.StorefrontApp.$1U = null;
